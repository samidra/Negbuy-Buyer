...
@Component({
  selector: 'app-sec-two-homepage',
  templateUrl: './sec-two-homepage.component.html',
  styleUrls: ['./sec-two-homepage.component.scss']
})
export class SecTwoHomepageComponent {
