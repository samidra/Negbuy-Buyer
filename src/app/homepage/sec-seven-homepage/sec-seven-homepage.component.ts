...
@Component({
  selector: 'app-sec-seven-homepage',
  templateUrl: './sec-seven-homepage.component.html',
  styleUrls: ['./sec-seven-homepage.component.scss']
})
export class SecSevenHomepageComponent {
  ...
  getDataCarousel() {
    ...
    const body = {
      category1: 'Animals & Pet Supplies',
      category2: '',
      number: 20
    }
    this.loader = true;
