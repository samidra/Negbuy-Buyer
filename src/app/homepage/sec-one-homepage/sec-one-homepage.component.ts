...
@Component({
  selector: 'app-sec-one-homepage',
  templateUrl: './sec-one-homepage.component.html',
  styleUrls: ['./sec-one-homepage.component.scss']
})
export class SecOneHomepageComponent {
