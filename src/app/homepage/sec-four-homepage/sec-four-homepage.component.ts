...
@Component({
  selector: 'app-sec-four-homepage',
  templateUrl: './sec-four-homepage.component.html',
  styleUrls: ['./sec-four-homepage.component.scss']
})
export class SecFourHomepageComponent {
  ...
  getDataCarousel() {
    ...
    const body = {
      category1: 'Baby & Toddler',
      category2: 'Business & Industrial',
      number: 20
    }
    this.loader = true;
