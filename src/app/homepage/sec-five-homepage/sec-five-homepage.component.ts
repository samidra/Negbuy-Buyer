...
@Component({
  selector: 'app-sec-five-homepage',
  templateUrl: './sec-five-homepage.component.html',
  styleUrls: ['./sec-five-homepage.component.scss']
})
export class SecFiveHomepageComponent {
  products_slide: any[] = [];
  loader = true;
  userlogin = false;
