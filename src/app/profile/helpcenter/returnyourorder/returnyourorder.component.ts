...
@Component({
  selector: 'app-returnyourorder',
  templateUrl: './returnyourorder.component.html',
  styleUrls: ['./returnyourorder.component.scss']
})
export class ReturnyourorderComponent {
  sectionLoaded = 0;
  ...
  ngOnInit() {
    const title = "Return Your Order | Help Center | Negbuy.com";
