...
@Component({
  selector: 'app-order-related-querry',
  templateUrl: './order-related-querry.component.html',
  styleUrls: ['./order-related-querry.component.scss']
})
export class OrderRelatedQuerryComponent {
  sectionLoaded = 0;
  ...
  ngOnInit() {
    const title = "Order Related Querry | Negbuy.com";
